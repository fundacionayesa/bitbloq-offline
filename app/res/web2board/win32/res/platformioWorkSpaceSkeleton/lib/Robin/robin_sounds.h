#ifndef robin_sounds_h
#define robin_sounds_h
...
// HIMNO BETIS
#define LONG_BETIS 22
#define RITMO_BETIS 1

#define LONG_SEVILLA 20
#define RITMO_SEVILLA 1

#define LONG_CUMPLE 26
#define RITMO_CUMPLE 1

#define LONG_SARIA 20
#define RITMO_SARIA 1
